...
public class User {
    ...
    public User(Integer id, String username, String password, String email, String phone, String question, String answer, Integer role, Date createTime, Date updateTime) {
        ...
        this.password = password;//MD5非对称加密
        this.email = email;//创建用户时会对email 与username 进行校验有则选择忘记密码
        this.phone = phone;
        this.question = question;//修改密码时候需要提供的问题
        this.answer = answer;//问题结果 此暂未完成功能
        this.role = role;//0：用户；1管理员
